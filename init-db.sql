...
-- Run this if the schema.sql didn't execute automatically
...
(
    ...
    'Administrator',
    'admin',
    'iak_live_' || encode(gen_random_bytes(32), 'hex')
) ON CONFLICT (email) DO UPDATE SET 
    api_key = COALESCE(users.api_key, 'iak_live_' || encode(gen_random_bytes(32), 'hex'));
